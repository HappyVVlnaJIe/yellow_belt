...
void TestsMyCustom()
{
...

    {
        ...
        AssertEqual(std::make_pair( Date{ 2019, 12, 3 }, "f"s), db.Last({ 2019, 12, 4 }), " My test 6");
        ...
        AssertEqual(std::make_pair( Date{ 2019, 12, 2 }, "c c"s), db.Last({ 2019, 12, 2 }), " My test 7");

        AssertEqual(std::make_pair( Date{ 2019, 12, 3 }, "f"s), db.Last({ 2019, 12, 4 }), " My test 8");

        db.Add({ 2019, 12, 3 }, "m");
        AssertEqual(std::make_pair( Date{ 2019, 12, 3 }, "m"s), db.Last({ 2019, 12, 3 }), " My test 9");
...

    {
        ...
        AssertEqual(std::make_pair( Date{ 2019, 12, 1 }, "c"s), db.Last({ 2019, 12, 1 }), " My test 20");

        db.Add({ 2019, 12, 1 }, "b");
        AssertEqual(std::make_pair( Date{ 2019, 12, 1 }, "c"s), db.Last({ 2019, 12, 1 }), " My test 21");
...
void TestDatabase() {
    ...
    // Last
    {
        ...
        db.Add(d1, "e1");
        db.Add(d2, "e2");
        AssertEqual(db.Last(d), std::make_pair( Date{ 2018, 12, 22 }, "e2"s ), "Db Last 1");
        Date d3(2018, 12, 24);
        db.Add(d3, "e3");
        AssertEqual(db.Last(d), std::make_pair(Date{ 2018, 12, 24 }, "e3"s), "Db Last 2");
        ...
        AssertEqual(db.Last(d), std::make_pair( Date{ 2018, 12, 22 }, "e2"s), "Db Last 4");

        AssertEqual(db.Last(d1), std::make_pair( Date{ 2019, 1, 2 }, "e1"s), "Db Last 5");
        db.Add(d2, "e4");
        AssertEqual(db.Last(d2), std::make_pair( Date{ 2018, 12, 22 }, "e4"s), "Db Last 6");
    }
